...
const Navbar = () => {
  return (
    <div className="flex justify-between md:mx-auto m-4 md:max-w-2/4 rounded-2xl shadow-sm bg-[#26282c]/60 backdrop-blur-md z-20 fixed top-0 left-0 right-0 p-3 hover:shadow-[#D3F9B5] duration-250">
